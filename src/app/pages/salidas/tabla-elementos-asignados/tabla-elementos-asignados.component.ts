      ...
      if (res && res.length > 0) {
        res.forEach(el => {
          el.Funcionario = '',
            ...
            el.Dependencia = '',
            el.Ubicacion = '',
            el.SubgrupoCatalogoId.ValorResidual = (el.SubgrupoCatalogoId.Depreciacion || el.SubgrupoCatalogoId.Amortizacion) ? el.SubgrupoCatalogoId.ValorResidual * 100 : 0,
            el.SubgrupoCatalogoId.VidaUtil = (el.SubgrupoCatalogoId.Depreciacion || el.SubgrupoCatalogoId.Amortizacion) ? el.SubgrupoCatalogoId.VidaUtil : 0,
